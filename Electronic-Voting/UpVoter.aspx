<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpVoter.aspx.cs" Inherits="Electronic_Voting.UpVoter" %>
...
<body>
    <form id="form1" runat="server">
         <div >
             <br/>
                        <h1 style="text-align:center; color:dodgerblue; text-decoration:underline; background-color:aliceblue">UPDATE VOTER</h1>
             <br/>
        </div>
        <div style="text-align:center; color:dodgerblue">
            ...
            <asp:Label ID="Label1" runat="server" Text="VoterID" Font-Bold="True" Font-Names="Arial Black" Font-Size="Large"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="VID" DataValueField="VID" Height="20px" Width="189px" BackColor="DodgerBlue" Font-Size="Large" ForeColor="White">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EVotingConnectionString %>" ProviderName="<%$ ConnectionStrings:EVotingConnectionString.ProviderName %>" SelectCommand="SELECT [VID] FROM [VOTER]"></asp:SqlDataSource>
            <br />
            <br/>
