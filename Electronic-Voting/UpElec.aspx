<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpElec.aspx.cs" Inherits="Electronic_Voting.UpElec" %>
...
<body>
    <form id="form1" runat="server">
         <div >
             <br/>
                        <h1 style="text-align:center; color:dodgerblue; text-decoration:underline; background-color:aliceblue">UPDATE ELECTIONS</h1>
             <br/>
        </div>
        <div style="text-align:center; color:dodgerblue">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="EID" DataValueField="EID" Height="20px" Width="189px" BackColor="DodgerBlue" Font-Size="Large" ForeColor="White">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EVotingConnectionString %>" ProviderName="<%$ ConnectionStrings:EVotingConnectionString.ProviderName %>" SelectCommand="SELECT [EID] FROM [ELECTION]"></asp:SqlDataSource>
            <br />
